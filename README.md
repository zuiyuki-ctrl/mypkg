...
- `std_msgs`: 標準ROS 2メッセージ型
- `launch_ros`: ROS 2ローンチシステム
...
`/system_resources`トピックは以下のようなメッセージを公開します:
